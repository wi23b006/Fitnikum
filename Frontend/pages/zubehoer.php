...
<?php include("../includes/navbar.php"); ?>
    ...
    <section class="hero">
        ...
        <h1>Zubehör</h1>
        <p>
            Hier findest du verschiedenes Trainingszubehör. Die Produkte sind aktuell nur Platzhalter
            und werden später im Projekt vollständig ergänzt.
        </p>
    </section>

    <section class="categories">
        <p class="section-label">Zubehör Produkte</p>

        <div class="search-bar">
            <input type="text" id="suchfeld" placeholder="Produkt suchen..." onkeyup="produkteSuchen()">
        </div>

        <div id="product-list" class="product-grid" data-category="zubehoer"></div>
